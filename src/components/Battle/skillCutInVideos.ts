...
// 不用動任何播放邏輯。目前有 17 位騎士的技能①有素材（主人提供的清單），技能②全部是 null；
// 保留 skill2 欄位是因為觸發規則本身（技能①「或」技能②都可能觸發）沒有限定只能是技能①，
// 純粹是這批素材目前只涵蓋技能①。
//
...
export const SKILL_VIDEO_MAP: Record<string, KnightCutInVideos> = {
  // ── 獨立騎士 ─────────────────────────────
  'silver-wing': { skill1: `${VIDEO_BASE}虛空裂切(強化版).mp4`, skill2: null },
  ...
  // ── 渾沌騎士陣營 ─────────────────────────
  solren: { skill1: null, skill2: null },
  magnos: { skill1: `${VIDEO_BASE}終焰血斬.mp4`, skill2: null },
  ignis: { skill1: `${VIDEO_BASE}業火爆裂衝.mp4`, skill2: null },
  eclron: { skill1: null, skill2: null },
  mordres: { skill1: null, skill2: null },
  ...
  gratos: { skill1: null, skill2: null },
}
